const methods = {
  handle : function(client, message, prefix, Discord) {
    ...
    const ach_command = require('./ach.js')
    ...
    switch (command.toLowerCase()) {
      case "achievement":
        log(client, args, "achievement")
        ach_command.run(client, args, message)
        break;
      case "level":
        log(client, args, "Level")
        level_command.get(client, message);
        break;
      case "daily":
        log(client, args, "Daily")
        money_command.daily(client, message)
        break;
      case "money":
        log(client, args, "Money")
        money_command.get(client, message);
        break;
      case "ghost":
